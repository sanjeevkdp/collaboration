...
public class UserController {
    ...
    @RequestMapping(value = "/userDetails/{userDetails_id}", method = RequestMethod.GET)
    public ResponseEntity<UserDetails> updateUserDetails(@PathVariable String userDetails_id) {
        System.out.println("Updating UserDetails " + userDetails_id);
          
        
        
        UserDetails currentUserDetails=userDetailsDao.findById(userDetails_id);
          
        if (currentUserDetails==null) {
            System.out.println("userDetails with userDetails_id " + userDetails_id + " not found");
