var user=angular.module('collaborationAppUser',['controllerUserService','ngRoute']);
user.controller('userController',[ '$scope','UserService','$http',function($scope,UserService,$http){
	var self=this;
